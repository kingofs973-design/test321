...
module.exports = {
  ...
  get botOwner()     { return process.env.OWNER_NAME     || 'JUNAID MD 302'; },
  ...
  // Public invite URL for the Join Channel button. NEWSLETTER_JID is the internal channel JID.
  get channelLink(){ return process.env.CHANNEL_LINK || process.env.WA_CHANNEL || 'https://whatsapp.com/channel/0029Vb7dmVQ6rsQt3kJY131f'; },
  get channelJid(){ return this.newsletterJid; },
